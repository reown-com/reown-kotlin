...
internal interface UniffiLib : Library {
    ...
    fun uniffi_uniffi_yttrium_fn_func_add(
        `a`: Int, `b`: Int, uniffi_out_err: UniffiRustCallStatus,
    ): Int
    ...
    fun uniffi_uniffi_yttrium_checksum_func_add(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_uniffi_yttrium_checksum_func_add() != 36247.toShort()) {
...
fun `add`(`a`: kotlin.UInt, `b`: kotlin.UInt): kotlin.UInt {
    return FfiConverterUInt.lift(
        uniffiRustCall() { _status ->
            UniffiLib.INSTANCE.uniffi_uniffi_yttrium_fn_func_add(
